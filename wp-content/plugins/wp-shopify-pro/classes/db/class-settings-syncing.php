   ...
   */
    ...
    public function set_syncing_totals($counts, $exclusions = [])
    {
        ...
        return [
            ...
            'orders' => $this->update_column_single(
                ['syncing_totals_orders' => $orders_totals],
                ['id' => 1]
            ),
            'customers' => $this->update_column_single(
                ['syncing_totals_customers' => $customers_totals],
                ['id' => 1]
            ),
            'webhooks' => $this->update_column_single(
                ['syncing_totals_webhooks' => $webhooks_totals],
                ['id' => 1]
            ),
        ];
    }
    ...
    public function reset_syncing_totals()
    {
        return [
            ...
            'orders' => $this->update_column_single(
                ['syncing_totals_orders' => 0],
                ['id' => 1]
            ),
            'customers' => $this->update_column_single(
                ['syncing_totals_customers' => 0],
                ['id' => 1]
            ),
            'webhooks' => $this->update_column_single(
                ['syncing_totals_webhooks' => 0],
                ['id' => 1]
            ),
            'media' => $this->update_column_single(
                ['syncing_totals_media' => 0],
                ['id' => 1]
            ),
        ];
    }
    ...
    public function reset_syncing_current_amounts()
    {
        return [
            ...
            'orders' => $this->update_column_single(
                ['syncing_current_amounts_orders' => 0],
                ['id' => 1]
            ),
            'customers' => $this->update_column_single(
                ['syncing_current_amounts_customers' => 0],
                ['id' => 1]
            ),
            'webhooks' => $this->update_column_single(
                ['syncing_current_amounts_webhooks' => 0],
                ['id' => 1]
            ),
            'media' => $this->update_column_single(
                ['syncing_current_amounts_media' => 0],
                ['id' => 1]
            ),
        ];
    }
    ...
    {
        return [
            'media_refs' => $this->update_column_single(
                ['recently_syncd_media_ref' => ''],
                ['id' => 1]
            ),
        ];

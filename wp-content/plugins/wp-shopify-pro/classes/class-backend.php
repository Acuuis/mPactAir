...
class Backend
{
    ...
    public function admin_scripts()
    {
        if ($this->should_load_js() && !$this->is_wizard_page()) {
            ...
            if (\is_plugin_active('wpshopify/wp-shopify.php')) {
                wp_die(
                    "Please deactivate the free version of WP Shopify before activating WP Shopify Pro. <br><br><a href=" .
                        admin_url('plugins.php') .
                        " class=\"button button-primary\">Back to plugins</a>."
                );
            }
            ...
            $runtime_url = WP_SHOPIFY_PLUGIN_URL . 'dist/runtime.470946.min.js';
            $vendors_admin_url =
                WP_SHOPIFY_PLUGIN_URL . 'dist/vendors-admin.470946.min.js';
            $main_url = WP_SHOPIFY_PLUGIN_URL . 'dist/admin.470946.min.js';
   ...
   */
    public function add_dashboard_menus()
    {
        ...
        if (apply_filters('wpshopify_show_dashboard', current_user_can('edit_pages'), $user)) {
            ...
            $plugin_name = WP_SHOPIFY_PLUGIN_NAME_FULL_PRO;
    ...
    public function wpshopify_blocks_assets()
    {
        if (is_admin()) {
            ...
            $vendors_admin_url =
                WP_SHOPIFY_PLUGIN_URL . 'dist/vendors-admin.470946.min.js';
            $main_url = WP_SHOPIFY_PLUGIN_URL . 'dist/blocks.470946.min.js';
    ...
    public function wpshopify_wizard_assets()
    {
        if ($this->is_wizard_page()) {
            ...
            $vendors_admin_url =
                WP_SHOPIFY_PLUGIN_URL . 'dist/vendors-admin.470946.min.js';
            $main_url = WP_SHOPIFY_PLUGIN_URL . 'dist/wizard.470946.min.js';
    ...
    public function init()
    {
        ...
        add_action('enqueue_block_assets', [$this, 'wpshopify_blocks_assets']);

        add_filter(
            'block_categories',
            [$this, 'wpshopify_block_categories'],
            10,
            2
        );
